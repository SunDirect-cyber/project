...
class AdminMenu {
	...
	public static function add_menu(): void {
		...
		add_submenu_page(
			self::SLUG,
			__( 'Rate Correlation', 'wc-multicurrency-switcher' ),
			__( 'Rate Correlation', 'wc-multicurrency-switcher' ),
			self::CAPABILITY,
			self::SLUG_RATE_CORRELATION,
			array( RateCorrelationPage::class, 'render' )
		);

		add_submenu_page(
			self::SLUG,
			__( 'Notifications', 'wc-multicurrency-switcher' ),
			__( 'Notifications', 'wc-multicurrency-switcher' ),
			self::CAPABILITY,
